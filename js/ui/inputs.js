...
export function setupInputs() {
    ...
    function attachInputKeyHandler(input) {
        ...
        input.addEventListener("input", () => {
            resetRouteStateOnManualChange("Maršruto duomenys pakeisti. Iš naujo parodyk maršrutą.");
        });
    }
    ...
    function createWaypointRow(value = "") {
        ...
        removeBtn.addEventListener("click", () => {
            block.remove();
            resetRouteStateOnManualChange("Stotelė pašalinta. Iš naujo parodyk maršrutą.");
